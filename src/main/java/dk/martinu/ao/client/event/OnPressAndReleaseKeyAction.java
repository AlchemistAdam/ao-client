 ...
 * and {@code KEY_RELEASED} that invokes a delegate
 * {@link KeyActionFunction function} when called.
 *
 * @author Adam Martinu
 * @version 1.0, 2023-02-05
 * @since 1.0
 */
public final class OnPressAndReleaseKeyAction extends KeyAction {
     ...
     */
    public OnPressAndReleaseKeyAction(final int priority, @NotNull final KeyActionFunction function) {
